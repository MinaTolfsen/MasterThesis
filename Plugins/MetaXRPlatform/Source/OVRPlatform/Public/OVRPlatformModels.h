...
/**
 * Results of the launched report dialog including resulting report ID and user action. It can be retrieved using UOvrRequestsBlueprintLibrary::AbuseReport_LaunchAdvancedReportFlow() to handle the result of a report request.
